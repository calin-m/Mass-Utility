...
const de: TranslationSchema = {
  ...
  diag_token_crypto_name: 'Token-Kryptographie',
  diag_token_crypto_desc: 'Nutzdatenverschlüsselung',
  diag_session_integ_name: 'Sitzungsintegrität',
  diag_session_integ_desc: 'OTT Anti-Replay Schutz',
  diag_sqlite_db_name: 'SQLite-Datenbankpfad',
  diag_lic_gate_name: 'Lizenzprüfungs-Gate',
  diag_lic_gate_desc: 'Signaturintegrität',
  diag_storage_name: 'Systemspeicher',
  diag_storage_desc: 'Lese- / Schreibrechte',
  diag_gateway_name: 'Lizenzierungs-Gateway-Engine',
  diag_gateway_desc: 'PHP 8.x PDO / cURL',
  diag_headers_title: 'HTTP-Sicherheits-Header',
  diag_headers_desc: 'Überprüft CORS-, CSP-, HSTS- und X-Frame-Header',
  diag_headers_btn: 'Diagnose Starten',
  diag_perms_title: 'Verzeichnisberechtigungen',
  diag_perms_desc: 'Prüft 0755 / 0644 Berechtigungskonformität',
  diag_perms_btn: 'Rechte Überprüfen',
  diag_ssl_title: 'SSL / TLS-Zertifikat',
  diag_ssl_desc: 'Prüft HTTPS-SSL-Handshake und Verschlüsselung',
  diag_ssl_btn: 'SSL Überprüfen',
  diag_audit_title: 'Sicherheitsereignis-Audit',
  diag_audit_desc: 'Überprüft Anmeldeversuche und Telemetrie',
  diag_audit_btn: 'Audit Inspektion',
  diag_btn_apply_headers: '.htaccess-Header Anwenden',
  diag_btn_repair_perms: 'Berechtigungen Reparieren',
  diag_btn_enforce_https: 'HTTPS-Umleitung Erzwingen',
  diag_btn_run_audit: 'System-Sicherheits-Audit Starten',
  diag_audit_prompt: 'Klicken Sie oben auf "System-Sicherheits-Audit Starten", um die Serverumgebung zu scannen.',
  diag_vuln_detected_title: 'Sicherheitslücken Erkannt',
  diag_vuln_detected_desc: 'Bitte überprüfen Sie die unten stehenden Endpunkte und nutzen Sie das Auto-Fix-Tool.',
  diag_all_passed_title: 'Alle Sicherheitsprüfungen Bestanden',
  err_portal_runtime_notice: 'Super Admin Portal - Laufzeithinweis',
  err_unexpected_boundary: 'Eine unerwartete Ausführungsgrenze ist aufgetreten.',
