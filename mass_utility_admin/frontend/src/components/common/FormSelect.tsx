  ...
  return (
    <div className="w-full space-y-1">
      ...
      <div className="relative flex items-center w-full">
        ...
        <select
          className={`w-full h-10 bg-pm-input border border-pm-border rounded-xl text-xs text-pm-text focus:outline-none focus:border-pm-primary focus:ring-1 focus:ring-pm-primary/30 transition-colors duration-150 cursor-pointer appearance-none ${
            Icon ? 'pl-9' : 'pl-3'
        ...
        <ChevronDown className="w-4 h-4 absolute right-3 text-pm-secondary pointer-events-none shrink-0" />
      </div>
