...
- **Scrollbar Layout Shift Protection (`scrollbar-gutter: stable`)**: Global CSS layout protection in `index.css` pre-reserving vertical scrollbar gutter space to guarantee 0 horizontal layout shift when switching tabs or toggling scrollbars.
