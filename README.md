...
- **Row Density Switcher (`<DirectoryToolbar>`)**: Standardized density toggle pill (`[Compact ⚡]` vs `[Comfortable ☕]`) allowing users to switch dynamically between 40px compact rows and 52px spacious rows across all directory tables.
